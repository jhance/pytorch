...
def main() -> None:
    ...
    if options.gen_lazy_ts_backend:
        ...
        ts_native_functions = os.path.join(root_path, "torch/csrc/lazy/ts_backend/ts_native_functions.cpp")
        ts_node_base = os.path.join(root_path, "torch/csrc/lazy/ts_backend/ts_node.h")
